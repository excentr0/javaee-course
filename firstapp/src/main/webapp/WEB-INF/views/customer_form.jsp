        ...
        <div class="col-12">
            ...
            <form action="${customerSubmitUrl}" method="post">
                ...
                <div class="form-group">
                    <label>Name</label>
                    <input value="${requestScope.customer.name}" type="text" class="form-control" id="name" name="name"
                           placeholder="Enter name">
                </div>
                <div class="form-group">
                    <label>Phone</label>
                    <input value="${requestScope.customer.phone}" type="text" class="form-control" id="phone"
                           name="phone"
