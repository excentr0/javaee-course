...
public class CategoryControllerServlet extends HttpServlet {
  ...
  public void init() {
    categoryRepository =
        (CategoryRepository) getServletContext().getAttribute("categoryRepository");
  }
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    if (req.getPathInfo() == null
      ...
      getServletContext()
          .getRequestDispatcher("/WEB-INF/views/category_form.jsp")
          .forward(req, resp);
    } else {
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
    if (req.getPathInfo() == null
      ...
      try {
        Category category =
            new Category(strId.isEmpty() ? null : Long.parseLong(strId), req.getParameter("name"));
