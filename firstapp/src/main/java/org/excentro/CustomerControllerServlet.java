...
import org.excentro.persist.Customer;
...
public class CustomerControllerServlet extends HttpServlet {
  ...
  public void init() {
    customerRepository =
        (CustomerRepository) getServletContext().getAttribute("customerRepository");
  }
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    if (req.getPathInfo() == null
      ...
      Customer customer = new Customer(null, "New customer", "0070000000");
      req.setAttribute("customer", customer);
      getServletContext()
          .getRequestDispatcher("/WEB-INF/views/customer_form.jsp")
          .forward(req, resp);
    } else {
